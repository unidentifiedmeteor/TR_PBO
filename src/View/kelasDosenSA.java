...
import Controller.KelasDosenSAController;
 ...
 * @author Lenovo
 */
public class kelasDosenSA extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(kelasDosenSA.class.getName());
    private final KelasDosenSAController controller;
    private final String kodeDosen;   // dosen yang lagi diliat

    /**
     * Creates new form mahasiswaSA
     */
    public kelasDosenSA(String kodeDosen) {
        initComponents();
        this.kodeDosen = kodeDosen;
        Connection conn = koneksi.getConnection();
        this.controller = new KelasDosenSAController(new KelasDAO(conn));
        loadTableKelasDosen();
        kodeDosenMatkul.setText("Dosen: " + kodeDosen);
    }

    private void loadTableKelasDosen() {
        DefaultTableModel model = new DefaultTableModel(new Object[]{"Kode Kelas", "Nama Kelas", "Hari", "Mulai", "Selesai", "Ruangan"}, 0) {
            @Override
        ...
        controller.loadKelasDosen(model, kodeDosen);
    }
