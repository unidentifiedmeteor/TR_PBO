 ...
 * @author Lenovo
 */
public class kelasMahasiswa extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(kelasMahasiswa.class.getName());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new kelasMahasiswa().setVisible(true));
    }
