 ...
 * @author Lenovo
 */
public class ambilMahasiswa extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ambilMahasiswa.class.getName());

    /**
     * Creates new form dashboardDosen
     */
    public ambilMahasiswa() {
        initComponents();
    }
